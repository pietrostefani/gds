...
3.  In the **Anaconda Terminal** write: `conda env create -n envs363 --file C:\envs456\envs456.yml` and press `Enter`; if the file is located elsewhere you'll need to use the corresponding file path.
