...
You might want to extract values from a raster data set, and then map them within a vector `sf` framework or extract them to analyse them statistically. If it therefore very useful to know how to extract:
...
# set the working directory to where you saved the ENVS363_563 data
