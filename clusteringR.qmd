# Lab in R {#sec-clusteringlabR .unnumbered}
...
Technically speaking, this is the same process as we have seen before to create weight matrices. The difference in this case is that we did not begin with a shapefile, but with a GeoJSON. This is a one-liner:
